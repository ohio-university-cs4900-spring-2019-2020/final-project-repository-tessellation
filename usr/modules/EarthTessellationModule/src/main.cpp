...
#include "GLViewEarthTessellationModule.h" // GLView subclass instantiated to drive this simulation
#include <iostream>
#include <memory>
#include <string>
#include <vector>
...
int main(int argc, char* argv[])
{
    ...
    do {
        std::unique_ptr<Aftr::GLViewEarthTessellationModule> glView(Aftr::GLViewEarthTessellationModule::New(args));
